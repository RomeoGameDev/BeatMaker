...
type Props = { sample?: Sample; settings?: Partial<TrackSettings>; playheadMs?: number; processed?: boolean; mode?: WaveformMode; slices?: Slice[]; selectedSliceId?: string; };
...
export default function SampleWaveform({ sample, settings, playheadMs, processed = false, mode = "original", slices = [], selectedSliceId }: Props) {
